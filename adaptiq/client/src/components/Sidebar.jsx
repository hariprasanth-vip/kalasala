...
export default function Sidebar() {
  const { activeTab, setActiveTab, studentProfile, handleNewChat } = useTutor();
      ...
      <div className="sidebar-footer">
        ...
        <div className="student-profile-card">
          ...
          <div className="student-info">
            ...
            <div className="student-email">{studentProfile.email}</div>
          </div>
        </div>

        {/* Learning Profile Expandable Box */}
        <div className="learning-profile-box">
          ...
          <div className="profile-stats-grid">
            <div className="stat-row">
              ...
              <span className="stat-value">{studentProfile.level}</span>
            </div>
            <div className="stat-row">
              <span className="stat-title">Concepts Mastered</span>
              <span className="stat-value">{studentProfile.conceptsMastered}</span>
            </div>
            <div className="stat-row">
              <span className="stat-title">Total Study Time</span>
              <span className="stat-value">{studentProfile.studyTime}</span>
            </div>
          </div>
        </div>

        {/* Log Out */}
        <button className="logout-button" onClick={() => alert('AdaptIQ session safely synced to MongoDB.')}>
          <LogOut size={16} />
          <span>Log Out</span>
        </button>
      </div>
